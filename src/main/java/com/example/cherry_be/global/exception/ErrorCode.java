...
public enum ErrorCode {
    ...
    ENCRYPTION_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "C008", "민감정보 저장에 실패했습니다."),
    DECRYPTION_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "C009", "민감정보 조회에 실패했습니다."),
    HEALTH_UNREADABLE(HttpStatus.CONFLICT, "M007", "기존 건강정보를 읽을 수 없어 수정할 수 없습니다. 삭제 후 다시 등록해주세요."),
    ...
    REFRESH_TOKEN_INVALID(HttpStatus.UNAUTHORIZED, "A002", "유효하지 않은 리프레시 토큰입니다."),
